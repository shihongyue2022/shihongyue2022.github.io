...
export const ui = {
  en: {
    ...
    nav: ['Certifications', 'About', 'Experience', 'Projects', 'Contact'], theme: 'Toggle theme', printResume: 'Print Resume',
    hello: "Hello, I'm", nameSuffix: '', viewProjects: 'View Projects', contactMe: 'Contact Me', overview: 'Profile overview',
    facts: ['Location', 'Focus', 'Work style'], aboutIndex: '02 / About', aboutTitle: 'What I bring to the table', skills: 'Skills',
    experienceIndex: '03 / Experience', experienceTitle: 'Research and professional experience', work: 'Research & Professional Experience', education: 'Education',
    projectsIndex: '04 / Projects', projectsTitle: 'Selected work',
    certificationsIndex: '01 / Certifications', certificationsTitle: 'Credentials & certifications', certificationsNote: 'Select a credential to verify it with the issuing organization.',
  ...
  ja: {
    ...
    nav: ['資格・認定', '概要', '経験', 'プロジェクト', '連絡先'], theme: 'テーマを切り替える', printResume: '履歴書を印刷',
    hello: 'はじめまして。', nameSuffix: 'です。', viewProjects: 'プロジェクトを見る', contactMe: 'お問い合わせ', overview: 'プロフィール概要',
    facts: ['所在地', '専門分野', '働き方'], aboutIndex: '02 / 概要', aboutTitle: '私が提供できる価値', skills: 'スキル',
    experienceIndex: '03 / 経験', experienceTitle: '業務・研究経験', work: '業務・研究経験', education: '学歴',
    projectsIndex: '04 / プロジェクト', projectsTitle: '主なプロジェクト',
    certificationsIndex: '01 / 資格・認定', certificationsTitle: '資格と認定', certificationsNote: '資格を選択すると、発行機関のサイトで確認できます。',
  ...
  zh: {
    ...
    nav: ['证书', '关于', '经历', '项目', '联系'], theme: '切换主题', printResume: '打印简历',
    hello: '你好，我是', nameSuffix: '', viewProjects: '查看项目', contactMe: '联系我', overview: '个人概览',
    facts: ['所在地', '专业方向', '工作方式'], aboutIndex: '02 / 关于', aboutTitle: '我能带来的价值', skills: '技能',
    experienceIndex: '03 / 经历', experienceTitle: '业务与研究经验', work: '业务与研究经验', education: '教育经历',
    projectsIndex: '04 / 项目', projectsTitle: '精选项目作品',
    certificationsIndex: '01 / 证书', certificationsTitle: '资格证书与认证', certificationsNote: '点击证书可前往发证机构验证。',
