...
export const ui = {
  en: {
    ...
    certificationsIndex: '03 / Certifications', certificationsTitle: 'Credentials & certifications', certificationsNote: 'Select a credential to verify it with the issuing organization.',
  ...
  ja: {
    ...
    nav: ['概要', '経験', '資格・認定', 'プロジェクト', '連絡先'], theme: 'テーマを切り替える', printResume: '履歴書を印刷',
    ...
    certificationsIndex: '03 / 資格・認定', certificationsTitle: '資格と認定', certificationsNote: '資格を選択すると、発行機関のサイトで確認できます。',
  ...
  zh: {
    ...
    nav: ['关于', '经历', '证书', '项目', '联系'], theme: '切换主题', printResume: '打印简历',
    ...
    certificationsIndex: '03 / 证书', certificationsTitle: '资格证书与认证', certificationsNote: '点击证书可前往发证机构验证。',
